...
extern "C" int init_sample_fd4222(void *param);
extern "C" int wake_up_and_convert_mode_fd4222();
extern "C" void end_sample_fd4222();
extern "C" void get_functions_fd4222(LPSAMPLE_FUNCTIONS lpsamplefunction);

SAMPLE_FUNCTIONS  _samplefunction_fd4222 = {
	init_sample_fd4222,
	wake_up_and_convert_mode_fd4222,
	end_sample_fd4222
...
int send(int file_fd4222, const char * title, unsigned char *snd_buff, int length){
...
extern "C" int send_n_recv_4_fd4222(const unsigned char*snd, int snd_size, unsigned char*recv, int* recv_size, void*etcparam)
{
	int                  success = 0;
	FT_STATUS            ftStatus;
	//FT_HANDLE            ftHandle = (FT_HANDLE)NULL;
	...
	NEO_TITLE(send_n_recv_4_fd4222);
	success = 0;
...
void get_functions_fd4222(LPSAMPLE_FUNCTIONS lpsamplefunction)
{
	*lpsamplefunction = _samplefunction_fd4222;

}


int init_sample_fd4222(void *param)
{
	NEO_TITLE(init_sample_fd4222);
	...
	Connect(&_devinfo);
	g3api_set_user_send_recv_pf(send_n_recv_4_fd4222, &_devinfo);
...
void end_sample_fd4222()
{
	NEO_TITLE(end_sample_fd4222);
	Disconnect(&_devinfo);

}

int wake_up_and_convert_mode_fd4222()
{
